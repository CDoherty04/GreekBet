 ...
 *   2. The AI describes and validates it (using group profile photos when
 *      available); a policy either locks in the outcome (`pending`) or hands
 *      it to the owner (`needs_owner`).
